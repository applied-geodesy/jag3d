...
public class TransformationEvent extends EventObject {
	...
	public enum TransformationEventType {
		TRANSFORMATION_MODEL_ADDED, TRANSFORMATION_MODEL_REMOVED  
	}
	
	private final TransformationEventType type;
	TransformationEvent(Transformation transformation, TransformationEventType type) {
	...
	public Transformation getSource() {
		return (Transformation)super.getSource();
	}
	
	public TransformationEventType getEventType() {
		return this.type;
	}
}