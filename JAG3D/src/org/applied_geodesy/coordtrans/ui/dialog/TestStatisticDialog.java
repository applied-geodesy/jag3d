...
public class TestStatisticDialog implements FormatterChangedListener {
	...
	private Node createPane() {
		...
		this.familywiseErrorRateCheckBox = UiUtil.createCheckBox(labelFamilywiseErrorRate, tooltipFamilywiseErrorRate);
		
		this.probabilityValueSpinner = UiUtil.createDoubleSpinner(CellValueType.PERCENTAGE, 0.0005, 0.30, 0.01, tooltipProbabilityValue);
		this.testPowerSpinner        = UiUtil.createDoubleSpinner(CellValueType.PERCENTAGE, 0.50, 0.9995, 0.01, tooltipTestPower);

		this.testStatisticTypeComboBox = UiUtil.createTestStatisticTypeComboBox(createTestStatisticTypeStringConverter(), i18N.getString("TestStatisticDialog.type.tooltip", "Select method for type I error adaption"));
