...
public class FormatterOptionDialog {
	...
	private TitledPane createFormatterOptionValuesPane() {
		...
		this.addRow(
    			...
    			i18n.getString("FormatterOptionDialog.unit.vector.value.tooltip.digits", "Set number of fraction digits for type vector"),
    			i18n.getString("FormatterOptionDialog.unit.vector.value.tooltip.unit", "Set unit for type vector value"),
				formatterOptions.get(CellValueType.VECTOR),
				gridPane,
				++row);
		...
		return UiUtil.createTitledPane(title, tooltip, gridPane);
	}
	...
	private TitledPane createFormatterOptionUncertaintiesPane() {
		...
		this.addRow(
    			...
    			i18n.getString("FormatterOptionDialog.unit.vector.uncertainty.tooltip.digits", "Set number of fraction digits for type vector uncertainty"),
    			i18n.getString("FormatterOptionDialog.unit.vector.uncertainty.tooltip.unit", "Set unit for type vector uncertainty"),
				formatterOptions.get(CellValueType.VECTOR_UNCERTAINTY),
				gridPane,
				++row);
	...
	private TitledPane createFormatterOptionResidualsPane() {
		...
		this.addRow(
    			...
    			i18n.getString("FormatterOptionDialog.unit.vector.residual.tooltip.digits", "Set number of fraction digits for type vector residual"),
    			i18n.getString("FormatterOptionDialog.unit.vector.residual.tooltip.unit", "Set unit for type vector residual"),
				formatterOptions.get(CellValueType.VECTOR_RESIDUAL),
				gridPane,
				++row);
	...
	private TitledPane createFormatterOptionStatisticsPane() {
		...
		this.addRow(
				i18n.getString("FormatterOptionDialog.unit.floatingpoint.label", "Floating-point:"),
    			i18n.getString("FormatterOptionDialog.unit.floatingpoint.tooltip.digits", "Set number of fraction digits for floating-point type"),
    			null,
				formatterOptions.get(CellValueType.DOUBLE),
				gridPane,
				++row);
