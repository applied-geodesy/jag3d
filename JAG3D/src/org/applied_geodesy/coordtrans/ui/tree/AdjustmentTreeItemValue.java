...
public class AdjustmentTreeItemValue extends TreeItemValue<TransformationAdjustment> {
	// root node
	AdjustmentTreeItemValue(String name) {
		super(name, TreeItemType.ADJUSTMENT);
		this.setObject(new TransformationAdjustment());
	}
