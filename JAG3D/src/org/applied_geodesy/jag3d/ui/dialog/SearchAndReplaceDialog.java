...
public class SearchAndReplaceDialog {
	...
	private Node createPane() {
		...
		Label searchLabel  = new Label(i18n.getString("SearchAndReplaceDialog.search.label", "Search:"));
		Label replaceLabel = new Label(i18n.getString("SearchAndReplaceDialog.replace.label", "Replace:"));
	...
	private RadioButton createRadioButton(String label, String tooltip) {
		RadioButton radioButton = new RadioButton();
		radioButton.setGraphic(new Label(label));
			...
			Platform.runLater(new Runnable() {
				@Override public void run() {
					OptionDialog.showThrowableDialog (
							i18n.getString("SearchAndReplaceDialog.message.error.sql.save.title", "SQL-Error"),
							i18n.getString("SearchAndReplaceDialog.message.error.sql.save.header", "Error, could not save changes in database table"),
							i18n.getString("SearchAndReplaceDialog.message.error.sql.save.message", "An exception occure during saving dataset to database."),
							e
							);
				}
			});
