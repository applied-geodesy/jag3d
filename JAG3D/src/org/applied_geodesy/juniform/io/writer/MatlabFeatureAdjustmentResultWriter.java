...
public class MatlabFeatureAdjustmentResultWriter {
	
	public void toFile(File binFile, FeatureAdjustment adjustment) throws NullPointerException, IllegalArgumentException, IOException {
		if (adjustment == null || adjustment.getFeature() == null)
		...
		List<UnknownParameter> unknownParameters = adjustment.getFeature().getUnknownParameters();
		...
		VarianceComponent varianceComponentOfUnitWeight = adjustment.getVarianceComponentOfUnitWeight();
		int degreeOfFreedom = (int)varianceComponentOfUnitWeight.getRedundancy();
