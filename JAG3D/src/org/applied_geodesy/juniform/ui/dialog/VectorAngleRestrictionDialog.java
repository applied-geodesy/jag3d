...
public class VectorAngleRestrictionDialog {
	...
	public static Optional<VectorAngleRestriction> showAndWait(ObservableList<UnknownParameter> unknownParameters, VectorAngleRestriction VectorAngleRestriction) {
		restrictionTypeDialog.init();
		restrictionTypeDialog.setUnknownParameters(unknownParameters);
		restrictionTypeDialog.setRestriction(VectorAngleRestriction);
	...
	private void init() {
		...
		this.dialog = new Dialog<VectorAngleRestriction>();
		...
		this.dialog.setResultConverter(new Callback<ButtonType, VectorAngleRestriction>() {
			@Override
	...
	private Node createPane() {
		...
		this.descriptionTextField = DialogUtil.createTextField(
				i18N.getString("VectorAngleRestrictionDialog.description.tooltip", "Description of parameter restriction"),
				i18N.getString("VectorAngleRestrictionDialog.description.prompt", "Restriction description"));
		...
		this.regressorAComboBox = DialogUtil.createUnknownParameterComboBox(
				...
				i18N.getString("VectorAngleRestrictionDialog.regressor.a.tooltip", "Select regressor a"));
		
		this.regressorBComboBox = DialogUtil.createUnknownParameterComboBox(
				UnknownParameterDialog.createUnknownParameterCellFactory(), 
				i18N.getString("VectorAngleRestrictionDialog.regressor.b.tooltip", "Select regressor b"));
		
		this.regressandComboBox = DialogUtil.createUnknownParameterComboBox(
				UnknownParameterDialog.createUnknownParameterCellFactory(), 
				i18N.getString("VectorAngleRestrictionDialog.regressand.tooltip", "Select regressand c"));
		...
		this.addParameterAButtom = DialogUtil.createButton(
				i18N.getString("VectorAngleRestrictionDialog.regressor.a.add.label", "+"),
				i18N.getString("VectorAngleRestrictionDialog.regressor.a.add.tooltip", "Add parameter to regressor list"));
		
		this.removeParameterAButtom = DialogUtil.createButton(
				i18N.getString("VectorAngleRestrictionDialog.regressor.a.remove.label", "-"),
				i18N.getString("VectorAngleRestrictionDialog.regressor.a.remove.tooltip", "Remove regressor"));
		
		this.moveUpParameterAButtom = DialogUtil.createButton(
				i18N.getString("VectorAngleRestrictionDialog.regressor.a.up.label", "\u25B2"),
				i18N.getString("VectorAngleRestrictionDialog.regressor.a.up.tooltip", "Move up (change order)"));
		
		this.moveDownParameterAButtom = DialogUtil.createButton(
				i18N.getString("VectorAngleRestrictionDialog.regressor.a.down.label", "\u25BC"),
				i18N.getString("VectorAngleRestrictionDialog.regressor.a.down.tooltip", "Move down (change order)"));
		...
		this.addParameterBButtom = DialogUtil.createButton(
				i18N.getString("VectorAngleRestrictionDialog.regressor.b.add.label", "+"),
				i18N.getString("VectorAngleRestrictionDialog.regressor.b.add.tooltip", "Add parameter to regressor list"));
		
		this.removeParameterBButtom = DialogUtil.createButton(
				i18N.getString("VectorAngleRestrictionDialog.regressor.b.remove.label", "-"),
				i18N.getString("VectorAngleRestrictionDialog.regressor.b.remove.tooltip", "Remove regressor"));
		
		this.moveUpParameterBButtom = DialogUtil.createButton(
				i18N.getString("VectorAngleRestrictionDialog.regressor.b.up.label", "\u25B2"),
				i18N.getString("VectorAngleRestrictionDialog.regressor.b.up.tooltip", "Move up (change order)"));
		
		this.moveDownParameterBButtom = DialogUtil.createButton(
				i18N.getString("VectorAngleRestrictionDialog.regressor.b.down.label", "\u25BC"),
				i18N.getString("VectorAngleRestrictionDialog.regressor.b.down.tooltip", "Move down (change order)"));
