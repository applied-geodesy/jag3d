 ...
 */
public class HeXMLNamespaceContext implements NamespaceContext {
	...
	public HeXMLNamespaceContext() {
		this.add("landxml",   "http://www.landxml.org/schema/LandXML-1.2");
		this.add("hexml",     "http://xml.hexagon.com/schema/HeXML-1.5");
	}
	...
	public Iterator<?> getPrefixes(String ns) {
		return this.ns2prefix.containsKey(ns) ? this.ns2prefix.get(ns).iterator() : Collections.EMPTY_SET.iterator();
	}
}
