...
public class DefaultFileChooser {
	...
	public static File showOpenDialog(Window window, String title, String initialFileName, ExtensionFilter... extensionFilters) {
	...
	public static List<File> showOpenMultipleDialog(Window window, String title, String initialFileName, ExtensionFilter... extensionFilters) {
		prepareFileChooser(title, initialFileName, extensionFilters);
	...
	public static File showSaveDialog(Window window, String title, String initialFileName, ExtensionFilter... extensionFilters) {
		prepareFileChooser(title, initialFileName, extensionFilters);
